...
-- Ensure GetVehicleColours is defined or imported from the appropriate API
if not GetVehicleColours then
...
-- Ensure GetSelectedPedWeapon is defined or imported from the appropriate API
if not GetSelectedPedWeapon then
...
-- Ensure 'cache' is defined or imported from the appropriate context
if not cache then
    cache = {}
    cache.ped = PlayerPedId and PlayerPedId() or nil
end
