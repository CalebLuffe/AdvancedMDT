...
-- Ensure HideHudComponentThisFrame is defined for environments where it may be missing
if not HideHudComponentThisFrame then
    function HideHudComponentThisFrame(id)
        -- Placeholder: Implement or bind to game API as needed
    end
end

-- Ensure HideHelpTextThisFrame is defined for environments where it may be missing
if not HideHelpTextThisFrame then
...
local function hideHUDThisFrame()
    ...
    -- HideHudAndRadarThisFrame() -- Commented out due to undefined global
    HideRadar() -- Use HideRadar() if you only want to hide the radar, or remove if not needed
    if type(HideHudComponentThisFrame) == "function" then
...
-- Ensure GetDisabledControlNormal is defined for environments where it may be missing
if not GetDisabledControlNormal then
    function GetDisabledControlNormal(group, control)
        -- Placeholder: Implement or bind to game API as needed
        return 0.0
    end
end

-- Ensure GetCamRot is defined for environments where it may be missing
if not GetCamRot then
